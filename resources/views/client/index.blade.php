...
<body>
    ...
    <div class="about" id="about">
        ...
        <div class="images">
            <img src="{{ asset('dist/img/CarRepairContent.webp') }}" alt="repair">
            <img src="{{ asset('dist/img/CarRepairContent1.webp') }}" alt="repair">
            <img src="{{ asset('dist/img/repair.jpg') }}" alt="repair">
        </div>
    </div>
        ...
        <div class="footer-content">
            ...
            <div class="social">
                ...
                <a href="https://www.facebook.com/MAZEFY00/">
                    <img src="{{ asset('dist/img/Facebook-removebg-preview (1).png') }}" alt="Facebook">
                </a>
                <a href="#"><img src="{{ asset('dist/img/ig-removebg-preview.png') }}" alt="Instagram"></a>
                <a href="#"><img src="{{ asset('dist/img/twitter-removebg-preview.png') }}" alt="Twitter"></a>
                <img src="{{ asset('dist/img/autoservbg.png') }}" alt="Autoserv Logo" class="autoserv-logo">
            </div>
        </div>
    </footer>
