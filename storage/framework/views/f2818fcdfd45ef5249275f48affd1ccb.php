            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.inprocess')); ?>" class="nav-link active">
                                <i class="nav-icon fas fa-car"></i>
                                <p>
                                    View Inprocess
                                </p>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body" style="max-height: 400px; overflow-y: auto; position: relative;">
                                                                ...
                                                                <div class="form-group" style="position: sticky; top: 0; background-color: #fff; z-index: 1;">
                                                                    <input type="text" id="addPartsSearchInput-<?php echo e($process->id); ?>" class="form-control" onkeyup="searchAddParts(<?php echo e($process->id); ?>)" placeholder="Search for parts...">
                                                                </div>
                                                                <form id="addPartsForm-<?php echo e($process->id); ?>" action="<?php echo e(route('client.parts.store')); ?>" method="POST">
                                                                    <?php echo csrf_field(); ?>
                                                                    <input type="hidden" name="process_id" value="<?php echo e($process->id); ?>">
                                                                    <div class="form-group">
                                                                        <label>Select Parts</label>
                                                                        <div id="addPartsList-<?php echo e($process->id); ?>">
                                                            ...
                                                            <div class="modal-footer" style="position: sticky; bottom: 0; background-color: #fff;">
                                                                ...
                                                                <button type="submit" form="addPartsForm-<?php echo e($process->id); ?>" class="btn btn-primary">Add Parts</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="max-height: 400px; overflow-y: auto; position: relative;">
                ...
                <div class="form-group" style="position: sticky; top: 0; background-color: #fff; z-index: 1; padding: 0.5rem;">
                    <label for="viewPartsSearchInput-<?php echo e($process->id); ?>">Search Parts</label>
                    <input type="text" id="viewPartsSearchInput-<?php echo e($process->id); ?>" class="form-control" onkeyup="searchViewParts(<?php echo e($process->id); ?>)" placeholder="Search for parts...">
                </div>
                <ul class="list-group" id="partsList-<?php echo e($process->id); ?>">
                    <?php
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $clientParts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clientPart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <li class="list-group-item part-item" id="partItem-<?php echo e($clientPart->id); ?>">
                            <?php echo e($clientPart->part->name_parts ?? 'N/A'); ?> - ₱<?php echo e($clientPart->part->price ?? 'N/A'); ?>

                            <button class="btn btn-danger btn-sm float-right" onclick="deletePart(<?php echo e($clientPart->id); ?>, <?php echo e($process->id); ?>)">Delete</button>
                        </li>
                        <?php
...
<?php /**PATH /Users/mac/Documents/3rdyr/LARAVEL2/laravelfromgit/Autoservs1stSem/resources/views/admin/inprocess.blade.php ENDPATH**/ ?>