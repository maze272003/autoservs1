                                    ...
                                    <table class="table table-head-fixed text-nowrap">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $processes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $process): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="#" data-toggle="modal"
                                                            data-target="#addPartsModal-<?php echo e($process->id); ?>"
                                                            class="text-success">
                                                        ...
                                                        <!-- View Parts Button -->
                                                        <a href="#" data-toggle="modal"
                                                            data-target="#viewPartsModal-<?php echo e($process->id); ?>"
                                                            class="text-info">
                                                            <i class="bx bx-show bx-md"></i>
                                                        </a>

                                                        <!-- Mark as Done Button -->
                                                        <form action="<?php echo e(route('process.done', $process->id)); ?>"
                                                        ...
                                                        <button class="text-primary border-0 bg-transparent"
                                                            data-toggle="modal"
                                                            data-target="#printModal-<?php echo e($process->id); ?>">
                                                ...
                                                <div class="modal fade" id="addPartsModal-<?php echo e($process->id); ?>"
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Add
                                                                    Parts for <?php echo e($process->user->name ?? 'N/A'); ?></h5>
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="<?php echo e(route('client.parts.store')); ?>"
                                                                    method="POST">
                                                                    <?php echo csrf_field(); ?>
                                                                    <input type="hidden" name="user_id"
                                                                        value="<?php echo e($process->user_id); ?>">
                                                                            ...
                                                                            <?php $__currentLoopData = $parts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $part): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        ...
                                                                                        id="part-<?php echo e($part->id); ?>">
                                                                                    <label class="form-check-label"
                                                                                        for="part-<?php echo e($part->id); ?>">
                                                                                        <?php echo e($part->name_parts); ?> -
                                                                                        $<?php echo e($part->price); ?> (Qty:
                                                ...
                                                <div class="modal fade" id="viewPartsModal-<?php echo e($process->id); ?>"
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="viewPartsModalLabel">Parts
                                                                    for <?php echo e($process->user->name ?? 'N/A'); ?></h5>
                                                                <button type="button" class="close"
                                                                    data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                                ...
                                                                <ul class="list-group">
                                                                    ...
                                                                    <?php $__empty_1 = true; $__currentLoopData = $clientParts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clientPart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                        <li class="list-group-item">
                                                                            <?php echo e($clientPart->part->name_parts ?? 'N/A'); ?>
                                                ...
                                                <!-- Print Modal -->
                                                <div class="modal fade" id="printModal-<?php echo e($process->id); ?>"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <h6>Total Price: $<span
                                                                        id="totalPrice-<?php echo e($process->id); ?>"><?php echo e($totalPrice); ?></span>
                                                                </h6>
                                                                <h6>Parts:</h6>
                                                                <ul id="partsList-<?php echo e($process->id); ?>"
                                                                    class="list-group">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="button" class="btn btn-primary"
                                                                    onclick="printReceipt('<?php echo e($process->id); ?>')">Print</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
<?php /**PATH C:\Users\Miner\Documents\jm\laravel4\github\autoservs1\resources\views/admin/inprocess.blade.php ENDPATH**/ ?>