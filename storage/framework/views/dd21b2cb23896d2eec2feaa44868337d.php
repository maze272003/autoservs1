...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <!-- BOOK -->
                        <li class="nav-item">
                            <a href="<?php echo e(route('book')); ?>" class="nav-link active">
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            <form id="bookingForm" class="row g-3" method="POST" action="<?php echo e(route('bookings.store')); ?>">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\John Michael Jonatas\Documents\advanceprog\autoservs1\resources\views/book.blade.php ENDPATH**/ ?>