...
<head>
    ...
    <title><?php echo e(config('app.name', 'Laravel')); ?> | Payment</title>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('payment.css')); ?>">
</head>
<style>
    * {
        margin: 0;
...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <!-- payment -->
                        <li class="nav-item">
                            <a href="<?php echo e(route('payment.show')); ?>" class="nav-link active">
                ...
                <div class="container">
                    <div class="flex-container">
                        ...
                        <div class="qr-container">
                            <img src="<?php echo e(asset('dist/img/qrpayment.jpg')); ?>" class="qr-image" alt="QR code" draggable="false" oncontextmenu="return false;" style="pointer-events: none;">
                        </div>
                        <!-- Table -->
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $processes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $process): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>₱<?php echo e(number_format($process->totalPrice, 2)); ?></td>
                                                <td><?php echo e($process->status); ?></td>
                                                <td>
                                                    <button class="btn btn-primary" data-toggle="modal" data-target="#viewPartsModal-<?php echo e($process->id); ?>">
                                                        View Added Parts
                                                    </button>
                                                </td>
                                                <td>
                                                    <button class="btn btn-secondary" data-toggle="modal" data-target="#uploadProofModal-<?php echo e($process->id); ?>">
                                                        Upload Proof
                                                    </button>
                                                </td>
                                            </tr>
                                            ...
                                            <div class="modal fade" id="viewPartsModal-<?php echo e($process->id); ?>" tabindex="-1" role="dialog" aria-labelledby="viewPartsModalLabel-<?php echo e($process->id); ?>" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="viewPartsModalLabel-<?php echo e($process->id); ?>">Added Parts for <?php echo e($process->serviceType); ?></h5>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <ul>
                                                                <?php $__currentLoopData = $process->clientParts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clientPart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <!-- Assuming you have a relationship defined -->
                                                                    <li><?php echo e($clientPart->part->name_parts); ?> - ₱<?php echo e(number_format($clientPart->part->price, 2)); ?></li>
                                            ...
                                            <div class="modal fade" id="uploadProofModal-<?php echo e($process->id); ?>" tabindex="-1" role="dialog" aria-labelledby="uploadProofModalLabel-<?php echo e($process->id); ?>" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="uploadProofModalLabel-<?php echo e($process->id); ?>">Upload Payment Proof for <?php echo e($process->serviceType); ?></h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form action="<?php echo e(route('processes.uploadProof', $process->id)); ?>" method="POST" enctype="multipart/form-data">
                                                                <?php echo csrf_field(); ?>
    ...
    <script src="<?php echo e(asset('payment.js')); ?>"></script>
</body>

</html>
<?php /**PATH C:\Users\John Michael Jonatas\Documents\advanceprog\autoservs1\resources\views/payment.blade.php ENDPATH**/ ?>