            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.response.messages')); ?>" class="nav-link active">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-info btn-sm" onclick="openReplyModal(<?php echo e($message->id); ?>, '<?php echo e($message->email); ?>')">Reply</button>
                                                        <button class="btn btn-danger btn-sm" onclick="deleteMessage(<?php echo e($message->id); ?>)">Delete</button>
                                                    </td>
                                                </tr>
    ...
    <script>
        function deleteMessage(messageId) {
            if (confirm('Are you sure you want to delete this message?')) {
                $.ajax({
                    url: '<?php echo e(url("admin/messages")); ?>/' + messageId,
                    method: 'DELETE',
                    data: {
        ...
        $('#replyForm').on('submit', function(event) {
            ...
            $.ajax({
                url: '<?php echo e(url("admin/messages/reply")); ?>', // Set this to the correct route for your reply logic
                method: 'POST',
                data: {
                    _token: '<?php echo e(csrf_token()); ?>',
                    messageId: messageId,
...
<?php /**PATH /Users/mac/Documents/3rdyr/LARAVEL2/laravelfromgit/Autoservs1stSem/resources/views/admin/responseMessage.blade.php ENDPATH**/ ?>