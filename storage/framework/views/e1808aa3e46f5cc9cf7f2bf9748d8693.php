...
<head>
    ...
    <title><?php echo e(config('app.name', 'Laravel')); ?> | maintenance history</title> 
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                       ...
                       <!-- history -->
                       <li class="nav-item">
                            <a href="<?php echo e(route('ClientHistory.maintenanceHistory')); ?>" class="nav-link active">
                                                                                    ...
                                                                                    <?php if($car->historyParts->isNotEmpty()): ?>
                                                                                        <?php $__currentLoopData = $car->historyParts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $part): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                            <tr>
                                                                                                ...
                                                                                                <td><?php echo e($part->part_price); ?></td>
                                                                                            </tr>
...
<?php /**PATH C:\Users\John Michael Jonatas\Documents\advanceprog\autoservs1\resources\views/ClientHistory/maintenanceHistory.blade.php ENDPATH**/ ?>