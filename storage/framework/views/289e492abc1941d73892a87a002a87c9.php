            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.createparts')); ?>" class="nav-link active">
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="<?php echo e(route('parts.store')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <table class="table table-striped" id="partsTable">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $parts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $part): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><?php echo e($part->name_parts); ?></td>
                                                        <td>₱<?php echo e(number_format($part->price, 2)); ?></td>
                                                        <td><?php echo e($part->quantity); ?></td>
                                                        <td><?php echo e($part->created_at->format('Y-m-d H:i:s')); ?></td>
                                                        <td>
                                                            <!-- Edit Button -->
                                                            <button class="btn btn-warning btn-sm" data-toggle="modal"
                                                                data-target="#editModal-<?php echo e($part->id); ?>">Edit</button>
                                    
                                                            <!-- Delete Button -->
                                                            <button class="btn btn-danger btn-sm" data-toggle="modal"
                                                                data-target="#deleteModal-<?php echo e($part->id); ?>">Delete</button>
                                    
                                                            <!-- Edit Modal -->
                                                            <div class="modal fade" id="editModal-<?php echo e($part->id); ?>" tabindex="-1" role="dialog"
                                                                aria-labelledby="editModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <form action="<?php echo e(route('parts.update', $part->id)); ?>" method="POST">
                                                                            <?php echo csrf_field(); ?>
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <div class="form-group">
                                                                                    <label for="name_parts">Part Name:</label>
                                                                                    <input type="text" class="form-control" id="name_parts"
                                                                                        name="name_parts" value="<?php echo e($part->name_parts); ?>" required>
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <label for="price">Price:</label>
                                                                                    <input type="number" step="0.01" class="form-control" id="price"
                                                                                        name="price" value="<?php echo e($part->price); ?>" required>
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <label for="quantity">Quantity:</label>
                                                                                    <input type="number" class="form-control" id="quantity"
                                                                                        name="quantity" value="<?php echo e($part->quantity); ?>" required>
                                                                                </div>
                                                                            </div>
                                                            ...
                                                            <!-- Delete Modal -->
                                                            <div class="modal fade" id="deleteModal-<?php echo e($part->id); ?>" tabindex="-1" role="dialog"
                                                                ...
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <form action="<?php echo e(route('parts.destroy', $part->id)); ?>" method="POST"
                                                                                class="d-inline">
                                                                                <?php echo csrf_field(); ?>
...
<?php /**PATH /Users/mac/Documents/3rdyr/LARAVEL2/laravelfromgit/Autoservs1stSem/resources/views/admin/createparts.blade.php ENDPATH**/ ?>