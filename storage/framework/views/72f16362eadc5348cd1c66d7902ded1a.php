                                            ...
                                            <?php $__currentLoopData = $parts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $part): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <!-- Edit Modal -->
                                                        <div class="modal fade" id="editModal-<?php echo e($part->id); ?>"
                                                            tabindex="-1" role="dialog"
                                                            aria-labelledby="editModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <form
                                                                        action="<?php echo e(route('parts.update', $part->id)); ?>"
                                                                        method="POST">
                                                                        <?php echo csrf_field(); ?>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text"
                                                                                    ...
                                                                                    value="<?php echo e($part->name_parts); ?>"
                                                                                    required>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label for="price">Price:</label>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="number"
                                                                                    ...
                                                                                    value="<?php echo e($part->quantity); ?>"
                                                                                    required>
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <!-- Delete Modal -->
                                                        <div class="modal fade" id="deleteModal-<?php echo e($part->id); ?>"
                                                            tabindex="-1" role="dialog"
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <form
                                                                            action="<?php echo e(route('parts.destroy', $part->id)); ?>"
...
<?php /**PATH /Users/mac/Documents/3rdyr/LARAVEL2/laravel from git/autoservs1 2/resources/views/admin/createparts.blade.php ENDPATH**/ ?>